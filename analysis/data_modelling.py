...
def get_unique_supplier_id(data: pd.DataFrame) -> set[int]:
    """
...
def get_unique_warehouse_id(data: pd.DataFrame) -> set[int]:
    """
...
def get_unique_region(data: pd.DataFrame) -> set[str]:
    """
